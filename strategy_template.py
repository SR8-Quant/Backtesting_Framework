...
if __name__ == "__main__":
    ...
    short_params = (500, 1.0, 0.0)

    # Generate signals
    signals = generate_signals(price_data, long_params, short_params)

    # Execute the strategy and get the equity curve
    equity = execute_trading_strategy(
        idx_len, price_data_np, price_data_pd, funding_signal, 
        signals, fee_rate, initial_cap
    )

    # Plot the results
    plot_results(price_data_np['open_time'], equity, price_data_np['close'])
